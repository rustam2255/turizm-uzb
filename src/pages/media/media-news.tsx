  ...
  return (
    <div  >
      <div className="max-w-[1800px]  mx-auto  px-4 md:px-[80px]">
        {/* Enhanced Filters */}
        <div   className="bg-gray-50 dark:bg-transparent  p-6 mb-10 border dark:border-gray-600">
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 text-black dark:text-white py-3 border border-gray-200  focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent bg-white dark:bg-transparent shadow-sm transition-all duration-200"
              />
            </div>
            ...
            <div className="relative min-w-[250px]">
              ...
              <select
                ...
                className="w-full pl-12 pr-4 py-3 border text-black dark:text-white border-gray-200  focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent bg-white dark:bg-transparent shadow-sm appearance-none cursor-pointer transition-all duration-200"
              >
          ...
          {newsLoading
            ...
            : currentNews.map((item: NewsItem) => (
              <Link to={`/media/news/detail/${item.id}-${slugify(item.title.uz || '')}`}>
                <div
                  key={item.id}
                  className="bg-white dark:bg-transparent border border-gray-100 dark:border-blue-950  shadow-sm overflow-hidden hover:shadow-lg hover:border-sky-200 transition-all duration-300 group cursor-pointer h-[430px]"
                >
        ...
        {!newsLoading && totalPages > 1 && (
          <div className="flex justify-center items-center mt-12 space-x-1">
            <div className="flex items-center space-x-1 bg-white  shadow-sm border border-gray-200 p-2">
