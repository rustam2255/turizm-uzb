  ...
  return (
    <div className="w-full px-4 md:px-[80px] pt-[100px] pb-16 max-w-[1500px] mx-auto">
      ...
      <div className="flex items-center text-[14px] font-sans font-medium md:text-[18px] gap-2">
        ...
        <span className="text-black">&gt;</span>
        <Link to="/services/clinics" className="hover:underline text-black">{t("services.clinic")}</Link>
        <span className="text-black">&gt;</span>
        <span className="text-[#DE5D26]">{clinic.name}</span>
      </div>

      {/* Title */}
      <h1 className="text-2xl md:text-4xl font-serif font-semibold mb-4">{clinic.name}</h1>
