  ...
  return (
    ...
    >
      <div className="flex flex-col items-start gap-y-2 md:gap-y-2.5 flex-1 pr-4">
        <h3 className="text-gray-900 dark:text-white text-[18px] leading-[26px] font-semibold tracking-[-0.01em] group-hover:text-blue-600 transition-colors duration-200 line-clamp-2">
          {title}
        </h3>
        <div className="flex flex-col gap-y-1">
          ...
          <p className="text-gray-500 text-[13px] leading-[140%] dark:text-sky-500 font-normal tracking-normal">
            {created_at}
          </p>
        </div>
      </div>
